...
const seed = async () => {
  try {
     ...
     const lids = [
      {
        ...
        inventory: 50, 
        color: 'black',
        imgUrl: 'https://www.williams-sonoma.com/wsimgs/ab/images/dp/wcm/201938/0246/yeti-rambler-bottle-straw-cap-o.jpg',
        description: 'The smartly desgined cap is durable and leak-resistant-and has a wide straw opening so you can enjoy more of your drink with every sip.',
      },
      {
        name: 'Rambler Bottle Chug Lid',
        type: 'lids',
        material: 'plastic and polypropylene with silicone gasket',
        price: 13.00,
        inventory: 50, 
        color: 'black',
        imgUrl: 'https://www.williams-sonoma.com/wsimgs/ab/images/dp/wcm/201938/1432/img38o.jpg',
        description: 'To open your bottle, just give the cap handles a quick half twist and youre good to go!'
      },
      {
        name: 'Flip Top Lid',
        type: 'lids',
      ...
      },
      {
        ...
        inventory: 50, 
        color: 'black',
        imgUrl: 'https://s7d5.scene7.com/is/image/UrbanOutfitters/54190129_001_b?$xlarge$&hei=900&qlt=80&fit=constrain',
        description: 'Flexible straw presses into the lid with a precise fit. Free of BPA'
      },
      {
        ...
        inventory: 50, 
        color: 'green',
        imgUrl: 'https://s7d5.scene7.com/is/image/UrbanOutfitters/55753792_030_b?$xlarge$&hei=900&qlt=80&fit=constrain',
        description: 'Screw-top cap features a handle loop. Fits wide mouth Hydro Flask bottles'
      },
    ]
    ...
    await Promise.all(lids.map((lid) => {
      return Product.create(lid)
    }))

    await Promise.all(straws.map((straw) => {
